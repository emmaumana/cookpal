...
class Recipe
  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[T::Enumerator[::Recipe]])
    end
  ...
  module GeneratedAssociationMethods
    # This method is created by ActiveRecord on the `Recipe` class because it declared `has_many :categories, through: :recipe_categories`.
    ...
    # This method is created by ActiveRecord on the `Recipe` class because it declared `has_many :recipe_categories`.
  ...
  module GeneratedAssociationRelationMethods
    ...
    sig { params(args: T.untyped, blk: T.untyped).returns(PrivateAssociationRelation) }
    def by_ingredients_search(*args, &blk); end
