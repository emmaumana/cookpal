...
module GeneratedPathHelpersModule
  ...
  sig { params(args: T.untyped).returns(String) }
  def api_v1_category_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def api_v1_ingredient_path(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def edit_api_v1_category_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def edit_api_v1_ingredient_path(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def new_api_v1_category_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def new_api_v1_ingredient_path(*args); end
