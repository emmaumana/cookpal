...
module MiniMagick
  ...
  class << self
    # source://mini_magick//lib/mini_magick.rb#25
    ...
    # @return [String]
    #
    # source://mini_magick//lib/mini_magick.rb#35
    def cli_version; end
...
module MiniMagick::Configuration
  ...
  # @return [Array<String>]
  #
  # source://mini_magick//lib/mini_magick/configuration.rb#16
  def cli_prefix; end
  ...
  # @yield [self]
  #
  # source://mini_magick//lib/mini_magick/configuration.rb#67
  def configure; end
  ...
  # @return [Boolean]
  #
  # source://mini_magick//lib/mini_magick/configuration.rb#46
  def errors; end
  ...
  # @return [Logger]
  #
  # source://mini_magick//lib/mini_magick/configuration.rb#31
  def logger; end
  ...
  # @return [String]
  #
  # source://mini_magick//lib/mini_magick/configuration.rb#38
  def tmpdir; end
  ...
  class << self
    # @private
    #
    # source://mini_magick//lib/mini_magick/configuration.rb#53
...
class MiniMagick::Shell
  ...
  # source://mini_magick//lib/mini_magick/shell.rb#41
